...
<table width=90% align=center class=myTable-gray>
	...
	<tr><td align=left class=titulo><font size=3>@<?php echo $_SESSION["user"];?> MENU MAESTROS </font></td></tr>
	<tr><td></td></tr>
	<tr><td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"]."?event=add_user";?>" class=link>CREAR USUARIO.</a></td></tr>
	<tr><td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"]."?event=show_user";?>" class=link>VER USUARIOS</a></td></tr>
