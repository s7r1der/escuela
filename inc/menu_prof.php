...
<table width=90% align=center class=myTable-gray>
	...
	<tr>
		<td align=left class=titulo>
			<font size=3>@<?php echo $_SESSION["user"]; ?> (MAESTROS)</font>
		</td>
	</tr>
	<tr>
		<td align=left><i><b>* 29 y 30 de Marzo</b> - Semana Santa</i></td>
	</tr>
	<tr>
		<td align=left><i><b>* 2 de Abril</b> - Dia del Veterano y de los Caídos en la Guerra de Malvinas.</i></td>
	</tr>
	<tr>
		<td>
			<hR>
	...
	<tr>
		<td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"] . "?event=nh_add_news"; ?>" class=link>CREAR NOTICIA.</a></td>
	</tr>
	<tr>
		<td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"] . "?event=nh_add_exam"; ?>" class=link>CREAR PRUEBA.</a></td>
	</tr>
	<tr>
