...
<table width=90% align=center class=myTable-gray>
	...
	<tr><td align=left class=titulo><font size=3>@<?php echo $_SESSION["user"];?> (MAESTROS)</font></td></tr>
	...
	<tr><td><hR></td></tr>
	<tr><td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"]."?event=nh_add_news";?>" class=link>CREAR NOTICIA.</a></td></tr>
	<tr><td align=left class=link><a href="<?php echo $_SERVER["PHP_SELF"]."?event=nh_add_exam";?>" class=link>CREAR PRUEBA.</a></td></tr>
	<tr><td align=left class=link><hr></td></tr>
