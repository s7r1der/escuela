...
//POST-->
	...
	if($_POST["event"]<>"VerDHC" 
	&& $_POST["event"]<>"Materiales_OS" && $_POST["event"]<>"Resumen Domicilio")include("inc/header.php");

	switch($_POST["event"]){

		case "VOLVER":	header("Location:".$_SERVER["PHP_SELF"]."?event=menu_user");     break;
